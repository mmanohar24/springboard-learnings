...
console.log(`Locations: ${first}, ${second}`);
...
const [ firstE, secondE, ...rest ] = elements;
console.log(`Essential Elements: ${firstE}, ${secondE}`);
...
{
    console.log( `Moving ${direction} towards ${distance}` );
}
revealPath( { direction: "North", distance: "10 miles"} );
...
function castSpel( [ spellIngredient1, spellIngredient2] )
{
    console.log( `Casting Spell with ${spellIngredient1} and ${spellIngredient2}`);
}
castSpel( ["Moonstone", "Stardust", "Sunlight"] );
...
console.log(`After Swap: stoneA = ${stoneA}, stoneB = ${stoneB}`);