...
SELECT o.first_name, o.last_name, COUNT(v.id) AS count FROM owners o 
JOIN vehicles v ON o.id = v.owner_id GROUP BY o.id, o.first_name, o.last_name ORDER BY o.first_name ASC;
...
*/
SELECT o.first_name, o.last_name, ROUND(AVG(v.price)) AS average_price, COUNT(v.id) AS count FROM owners o
JOIN vehicles v ON o.id = v.owner_id 
GROUP BY o.id, o.first_name, o.last_name HAVING count(v.id) > 1 AND AVG(v.price) > 10000 ORDER BY o.first_name DESC;